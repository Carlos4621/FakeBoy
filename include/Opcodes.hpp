...
static constexpr uint8_t CP_A_A_Opcode{ 0xBF };
static constexpr uint8_t CP_A_B_Opcode{ 0xB8 };
static constexpr uint8_t CP_A_C_Opcode{ 0xB9 };
static constexpr uint8_t CP_A_D_Opcode{ 0xBA };
...
static constexpr uint8_t JP_C_u16_Opcode{ 0xDA };
static constexpr uint8_t JP_NZ_u16_Opcode{ 0xC2 };
...
static constexpr uint8_t JR_C_i8_Opcode{ 0x38 };
static constexpr uint8_t JR_NC_i8_Opcode{ 0x30 };

static constexpr uint8_t PUSH_AF_Opcode{ 0xF5 };
static constexpr uint8_t PUSH_BC_Opcode{ 0xC5 };
