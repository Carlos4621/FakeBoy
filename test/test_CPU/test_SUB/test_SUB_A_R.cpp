...
static constexpr std::string_view CartidgePath{ "test_SUB_A_R_ROM.gb" };
...
class CPU_SUB_A_R : public ::testing::Test {
protected:
...
TEST_F(CPU_SUB_A_R, SUB_A_R_OpcodesWorks) {
...
TEST_F(CPU_SUB_A_R, SUB_A_R_ZeroFlagWorks) {
...
TEST_F(CPU_SUB_A_R, SUB_A_R_HalfCarryFlagWorks) {
...
TEST_F(CPU_SUB_A_R, SUB_A_R_CarryFlagWorks) {
...
TEST_F(CPU_SUB_A_R, SUB_A_R_CarryWithHalfCarryFlagWorks) {
