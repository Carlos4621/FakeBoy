...
static constexpr std::string_view CartidgePath{ "test_SUB_A_addressHL_ROM.gb" };
...
class CPU_SUB_A_addressHL : public ::testing::Test {
protected:
...
TEST_F(CPU_SUB_A_addressHL, SUB_A_addressHL_OpcodesWorks) {
