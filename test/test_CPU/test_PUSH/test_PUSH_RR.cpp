...
static constexpr std::string_view CartidgePath{ "test_PUSH_RR_ROM.gb" };
static constexpr uint16_t MinimumTCyclesNeeded{ 384 };

static constexpr std::array ExpectedValues {
    0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF, 0xF0, 0xB0
};

class CPU_PUSH_RR : public ::testing::Test {
protected:
...
TEST_F(CPU_PUSH_RR, PUSH_RR_OpcodesWorks) {
