...
static constexpr std::string_view CartidgePath{ "test_LD_addressC_A_ROM.gb" };
...
class CPU_LD_addressC_A : public ::testing::Test {
protected:
...
TEST_F(CPU_LD_addressC_A, LD_addressC_A_OpcodesWorks) {
