...
static constexpr std::string_view CartidgePath{ "test_JR_NZ_i8_ROM.gb" };
static constexpr uint16_t MinimumTCyclesNeeded{ 80 };

static constexpr std::array ExpectedValues {
    0, 0x33
};

class CPU_JR_NZ_i8 : public ::testing::Test {
protected:
...
TEST_F(CPU_JR_NZ_i8, JR_NZ_i8_OpcodesWorks) {
