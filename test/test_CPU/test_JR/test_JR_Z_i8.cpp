...
static constexpr std::string_view CartidgePath{ "test_JR_Z_i8_ROM.gb" };
static constexpr uint16_t MinimumTCyclesNeeded{ 196 };

static constexpr std::array ExpectedValues {
    0x11
};

class CPU_JR_Z_i8 : public ::testing::Test {
protected:
...
TEST_F(CPU_JR_Z_i8, JR_Z_i8_OpcodesWorks) {
