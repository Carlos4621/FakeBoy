...
static constexpr std::string_view CartidgePath{ "test_JR_i8_ROM.gb" };
static constexpr uint16_t MinimumTCyclesNeeded{ 192 };

static constexpr std::array ExpectedValues {
    5
};

class CPU_JR_i8 : public ::testing::Test {
protected:
...
TEST_F(CPU_JR_i8, JR_i8_OpcodesWorks) {
