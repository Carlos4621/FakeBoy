...
static constexpr std::string_view CartidgePath{ "test_ADC_A_addressHL_ROM.gb" };
...
class CPU_ADC_A_addressHL : public ::testing::Test {
protected:
...
TEST_F(CPU_ADC_A_addressHL, ADC_A_addressHL_OpcodesWorks) {
