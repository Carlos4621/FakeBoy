...
static constexpr std::string_view CartidgePath{ "test_LD_addressU16_SP_ROM.gb" };
static constexpr uint16_t MinimumTCyclesNeeded{ 84 };

static constexpr std::array ExpectedValues {
    0xAA, 0xBB, 0xCC, 0xDD
};

class CPU_LD_AddressU16_SP : public ::testing::Test {
protected:
...
TEST_F(CPU_LD_AddressU16_SP, LD_addressU16_SP_OpcodesWorks) {
