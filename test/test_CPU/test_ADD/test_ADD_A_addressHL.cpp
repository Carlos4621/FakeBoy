...
static constexpr std::string_view CartidgePath{ "test_ADD_A_addressHL_ROM.gb" };
static constexpr uint16_t MinimumTCyclesNeeded{ 140 };

static constexpr std::array ExpectedValues {
    3, 9
};

class CPU_ADD_A_addressHL : public ::testing::Test {
protected:
...
TEST_F(CPU_ADD_A_addressHL, ADD_A_addressHL_OpcodesWorks) {
