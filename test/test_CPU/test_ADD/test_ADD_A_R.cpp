...
static constexpr std::string_view CartidgePath{ "test_ADD_A_R_ROM.gb" };
static constexpr uint16_t MinimumTCyclesNeeded{ 272 };
...
class CPU_ADD_A_R : public ::testing::Test {
protected:
...
TEST_F(CPU_ADD_A_R, ADD_A_R_OpcodesWorks) {
...
TEST_F(CPU_ADD_A_R, ADD_A_R_ZeroFlagWorks) {
...
TEST_F(CPU_ADD_A_R, ADD_A_R_HalfCarryFlagWorks) {
...
TEST_F(CPU_ADD_A_R, ADD_A_R_CarryFlagWorks) {
...
TEST_F(CPU_ADD_A_R, ADD_A_R_CarryWithHalfCarryFlagWorks) {
...
TEST_F(CPU_ADD_A_R, ADD_A_R_CarryWithZeroWithHalfCarryFlagWorks) {
