...
static constexpr std::string_view CartidgePath{ "test_LD_A_addressC_ROM.gb" };
...
class CPU_LD_A_addressC : public ::testing::Test {
protected:
...
TEST_F(CPU_LD_A_addressC, LD_A_addressC_OpcodesWorks) {
