...
static constexpr std::string_view CartidgePath{ "test_LDH_addressU8_A_ROM.gb" };
...
class CPU_LDH_addressU8_A : public ::testing::Test {
protected:
...
TEST_F(CPU_LDH_addressU8_A, LDH_addressU8_A_OpcodesWorks) {
