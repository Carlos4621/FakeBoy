...
static constexpr std::string_view CartidgePath{ "test_LD_RR_u16_ROM.gb" };
...
class CPU_LD_RR_u16_Test : public ::testing::Test {
protected:
...
TEST_F(CPU_LD_RR_u16_Test, LD_RR_u16_OpcodesWorks) {
