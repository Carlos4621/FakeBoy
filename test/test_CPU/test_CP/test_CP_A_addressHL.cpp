...
static constexpr std::string_view CartidgePath{ "test_CP_A_addressHL_ROM.gb" };
...
class CPU_CP_A_addressHL : public ::testing::Test {
protected:
...
TEST_F(CPU_CP_A_addressHL, CP_A_addressHL_OpcodesWorks) {
