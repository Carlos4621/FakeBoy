...
static constexpr std::string_view CartidgePath{ "test_CP_A_R_ROM.gb" };
...
static constexpr std::array ExpectedValues {
    0, 5, 7, 9, 0xA, 0xB, 0x10
};

class CPU_CP_A_R : public ::testing::Test {
protected:
...
TEST_F(CPU_CP_A_R, CP_A_R_OpcodesWorks) {
...
TEST_F(CPU_CP_A_R, CP_A_R_ZeroFlagWorks) {
...
TEST_F(CPU_CP_A_R, CP_A_R_HalfCarryFlagWorks) {
...
TEST_F(CPU_CP_A_R, CP_A_R_CarryFlagWorks) {
...
TEST_F(CPU_CP_A_R, CP_A_R_CarryWithHalfCarryFlagWorks) {
