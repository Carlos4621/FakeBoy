...
static constexpr std::string_view CartidgePath{ "test_XOR_A_u8_ROM.gb" };
...
class CPU_XOR_A_u8 : public ::testing::Test {
protected:
...
TEST_F(CPU_XOR_A_u8, XOR_A_u8_OpcodesWorks) {
...
TEST_F(CPU_XOR_A_u8, XOR_A_u8_ZeroFlagWorks) {
