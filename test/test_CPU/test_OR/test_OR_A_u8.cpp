...
static constexpr std::string_view CartidgePath{ "test_OR_A_u8_ROM.gb" };
...
class CPU_OR_A_u8 : public ::testing::Test {
protected:
...
TEST_F(CPU_OR_A_u8, OR_A_u8_OpcodesWorks) {
...
TEST_F(CPU_OR_A_u8, OR_A_u8_ZeroFlagWorks) {
