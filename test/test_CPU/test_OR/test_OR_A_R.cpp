...
static constexpr std::string_view CartidgePath{ "test_OR_A_R_ROM.gb" };
...
static constexpr std::array ExpectedValues {
    0b00000001, 0b00000011, 0b00000110, 0b00001100, 0b00011000, 0
};

class CPU_OR_A_R : public ::testing::Test {
protected:
...
TEST_F(CPU_OR_A_R, OR_A_R_OpcodesWorks) {
...
TEST_F(CPU_OR_A_R, OR_A_R_ZeroFlagWorks) {
